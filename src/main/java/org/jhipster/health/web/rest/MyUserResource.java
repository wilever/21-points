...
public class MyUserResource {
    ...
    public ResponseEntity<List<MyUser>> getAllMyUsers(Pageable pageable) {
        log.debug("REST request to get a page of MyUsers");
        Page<MyUser> page = myUserService.findAll(pageable);
        HttpHeaders headers = PaginationUtil.generatePaginationHttpHeaders(page, "/api/my-users");
